...
<div class="templatemo-content-widget templatemo-login-widget white-bg">
    ...
    <form action="teacherlogin.action" class="templatemo-login-form">
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>
                <input type="text" class="form-control" placeholder="输入账号" name="teacher_tnum">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-key fa-fw"></i></div>
                <input type="password" class="form-control" placeholder="输入密码" name="teacher_tpwd">
            </div>
        </div>
        <div class="form-group">
...
<div class="templatemo-content-widget templatemo-login-widget templatemo-register-widget white-bg">
    <p>还没有账号？<strong><a href="register.jsp" class="blue-text">点击注册!</a></strong></p>
</div>
</body>
</html>
