...
<div class="templatemo-content col-1 light-gray-bg">
    ...
    <div class="templatemo-content-container">
        <div class="templatemo-content-widget white-bg">
            ...
            <p>New chapter</p>
            <form name="form1" action="addPart.action" onsubmit="return myCheck()" class="templatemo-login-form"
                ...
                <div class="row form-group">
                    <div class="col-lg-6 col-md-6 form-group">
                        ...
                        <input name="pcontent1" type="text" class="form-control"
                               placeholder="填写提取地址：如：https://pan.baidu.com/s/1skAa6b7">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-6 col-md-6 form-group">
