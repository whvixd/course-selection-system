    ...
    <%@ include file="left.jsp"%>
      ...
      <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form name="form1"action="addCourse.action" onsubmit="return myCheck()" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              ...
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    ...
                    <textarea name="cintro"class="form-control" id="inputNote" rows="10" placeholder="简单介绍一下你的课程吧"></textarea>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
