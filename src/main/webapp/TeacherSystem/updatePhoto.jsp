   ...
   <div class="templatemo-content-container">
          ...
          <div class="templatemo-flex-row flex-content-row">
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center templatemo-position-relative">
              ...
              <img src="upload/${oclsTeacher.tphoto}" alt="Bicycle" class="img-circle img-thumbnail margin-bottom-30">
             ...
             <form name="form1" onsubmit="return myCheck()" action="updatePhoto.action" class="templatemo-login-form" method="post" enctype="multipart/form-data">
