                  ...
                  <c:forEach items="${courselistnew}" var="c">
                    <td><br>
                     ...
                     <div class="cnameheight">
                   	...
                   	${c.ctime}<br>
                   	<br>
                   	<a href="showCourseDetail.action?cid=${c.cid}" class="templatemo-edit-btn">编辑</a></b></td>
                   	</c:forEach>
                 <td><div style="width:100px;word-wrap:break-word;" ></div><br><br><br><br>
                    ...
                    <td><br>
                     <img src="upload/${p.cphoto }" width="200" height="100" ><br>
                      <div class="cnameheight">
                   	...
                   	${p.ctime }<br>
                   	<br>
                   	<a href="showCourseDetail.action?cid=${p.cid}" class="templatemo-edit-btn">编辑</a></b></td>
                   	</c:forEach>
